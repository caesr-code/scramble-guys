...
const SKINS = ['Rookie Bean', 'Star Belt', 'Lightning', 'Dino Spots', 'Galaxy', 'Outhouse', 'Crown Knight', 'Soda Can', 'Traffic Cone', 'Dragon', 'Bubble Tea', 'Pirate', 'Robot'];
const PASS_REWARDS = [
  ...
  { level: 13, label: 'Dragon' }, { level: 14, label: 'Bubble Tea' }, { level: 15, label: 'Pirate' }, { level: 16, label: 'Robot' },
];
