...
export class SpinCycleLevel extends BaseLevel {
  ...
  build() {
    ...
    // Start pad is visual-only; the bridge floor underneath already collides.
    // Keeping two overlapping physics floors here caused the same slow/no-jump
    // spawn-platform bug as Door Dash.
    const startPadGeo = new THREE.BoxGeometry(bridgeWidth, 0.08, 10);
