...
export class Game {
  ...
  _pickLevels() {
    ...
    return [DoorDashLevel, HexHavocLevel];
  }
  ...
  _cameraTargetForLocal() {
    ...
    const target = this.characters.get(this.spectatorTargetId);
    return target && !target.eliminated && !target.qualified ? target : candidates[0][1];
  }
