...
export class Character {
  ...
  applyInput(input, camYaw, dt) {
    ...
    this.spawnControlGrace = Math.max(0, (this.spawnControlGrace || 0) - dt);
    ...
    const supported = canGroundAct || this.spawnControlGrace > 0 || (this.airTime < 0.12 && this.body.velocity.y > -0.5 && this.body.velocity.y < 0.5);
