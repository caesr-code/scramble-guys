...
// Collision groups: default Cannon bodies are group 1. Beans use group 2 and
// deliberately collide with the world only. This removes the spawn-pad crowd
// glue where 20 player/bot bodies solved against each other every frame and
// made movement feel like wading through concrete.
const WORLD_GROUP = 1;
