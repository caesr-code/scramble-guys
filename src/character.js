...
const GROUND_SNAP_TOLERANCE = 0.1;
...
export class Character {
  ...
  _groundProbe() {
    ...
    if (closeEnough) {
      ...
      if (this.body.velocity.y < 0 && best.distance <= footDistance + 0.035) {
        this.body.velocity.y = Math.max(this.body.velocity.y, -0.8);
      }
