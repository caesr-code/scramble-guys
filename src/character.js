...
const MOVE_ACCEL = 360;
const AIR_CONTROL = 0.46;
const MAX_SPEED = 21.5;
...
export class Character {
  ...
  applyInput(input, camYaw, dt) {
    ...
    if (hasInput && canGroundAct && !isDiving) {
      this.body.velocity.x = THREE.MathUtils.lerp(this.body.velocity.x, targetVX, Math.min(1, dt * 26));
      this.body.velocity.z = THREE.MathUtils.lerp(this.body.velocity.z, targetVZ, Math.min(1, dt * 26));
    }
